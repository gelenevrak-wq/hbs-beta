...
const translations: Record<string, Record<string, string>> = {
  tr: {
    ...
    warehouseTwin: "Dijital Depo İkizi",
  ...
  en: {
    ...
    warehouseTwin: "Digital Warehouse Twin",
  ...
  ru: {
    ...
    warehouseTwin: "Цифровой двойник склада",
  ...
  ka: {
    ...
    warehouseTwin: "საწყობის ციფრული ტვინი",
  ...
  de: {
    ...
    warehouseTwin: "Digitaler Lager-Zwilling",
...
const getMenuItems = (lang: string) => {
  ...
  return [
    ...
    { label: t.warehouseTwin, trLabel: "Dijital Depo İkizi", href: "/dashboard/warehouse-map" },
