  ...
  return (
    <main className="hbs-market-page min-h-screen px-3 py-3 text-slate-950 sm:px-6 sm:py-8">
      <div className="mx-auto max-w-lg rounded-[1.7rem] border border-slate-200 bg-white p-5 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-4 grid gap-3"><input className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-900 outline-none" placeholder="E-posta veya telefon" /><button className="rounded-xl bg-slate-950 px-4 py-2.5 text-sm font-black text-white">Kurtarma bağlantısı gönder</button></form>
