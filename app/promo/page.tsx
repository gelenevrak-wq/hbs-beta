...
const uiTexts = {
  tr: {
    ...
    ctaButton: "Mağaza Kaydınızı Hemen Yapın (30 Gün Ücretsiz) 🚀",
    exploreButton: "Platformu Keşfet",
    homeLabel: "🏠 Ana Sayfa",
    freeTrialButton: "30 Gün Ücretsiz Başlat 🚀",
    ...
    freeTrialGift: "30 Gün Tamamen Ücretsiz",
  ...
  en: {
    ...
    ctaButton: "Register Your Store Now (30 Days Free) 🚀",
    exploreButton: "Explore Platform",
    homeLabel: "🏠 Home",
    freeTrialButton: "Start 30 Days Free 🚀",
    repeatLabel: "Replay",
    ...
    freeTrialGift: "30 Days Completely Free",
  ...
  de: {
    ...
    ctaButton: "Registrieren Sie Ihren Shop jetzt (30 Tage kostenlos) 🚀",
    exploreButton: "Plattform erkunden",
    homeLabel: "🏠 Startseite",
    freeTrialButton: "30 Tage kostenlos starten 🚀",
    ...
    freeTrialGift: "30 Tage völlig kostenlos",
  ...
  ru: {
    ...
    ctaButton: "Зарегистрировать магазин сейчас (30 дней бесплатно) 🚀",
    exploreButton: "Исследовать платформу",
    homeLabel: "🏠 Главная",
    freeTrialButton: "Начать 30 дней бесплатно 🚀",
    ...
    freeTrialGift: "30 дней абсолютно бесплатно",
  ...
  ka: {
    ...
    ctaButton: "დაარეგისტრირეთ მაღაზია ახლავე (30 დღე უფასო) 🚀",
    exploreButton: "პლატფორმის შესწავლა",
    homeLabel: "🏠 მთავარი",
    freeTrialButton: "დაიწყე 30 დღე უფასოდ 🚀",
    ...
    freeTrialGift: "30 დღე სრულიად უფასოდ",
